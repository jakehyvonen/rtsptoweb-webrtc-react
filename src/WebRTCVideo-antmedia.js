...
export default class WebRTCVideo extends React.Component {
    ...
    render() {
        return (
            <div>
              <video src='http://localhost:5080/LiveApp/play.html?name=u0lONrK5Wj4p1670352637609'/>
            </div>
        );
      }
}
...
/*
  <h1>RTSPtoWeb WebRTC example</h1>
                ...
                <input type="hidden" name="webrtc-url" id="webrtc-url"
                    value="http://localhost:5080/LiveApp/play.html?name=u0lONrK5Wj4p1670352637609"></input>
